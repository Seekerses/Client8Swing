...
public class Update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        key.setText(TableController.getCurrentTable().getKeyByValue(product));
        ...
        xCoord.setText(((Double)product.getCoordinates().getX()).toString());
        ...
        unit.setSelectedItem(product.getUnitOfMeasure().toString());
        if (product.getManufacturer() != null){
            addOrg.setSelected(true);
            addOrgActionPerformed(null);
            manufacturer.setText(product.getManufacturer().getName());
        }else {
            manufacturer.setEditable(false);
            manufacturer.setEnabled(false);
        }
        if (product.getManufacturer() != null){
            fullName.setText(((Integer)product.getManufacturer().getId()).toString());
        }else {
            fullName.setEditable(false);
            fullName.setEnabled(false);
        }
        if (product.getManufacturer() != null && product.getManufacturer().getType() != null){
            orgType.setSelected(true);
            type.setSelectedItem(product.getManufacturer().getType());
        }else {
            type.setEnabled(false);
        }
        if (product.getManufacturer() != null && product.getManufacturer().getPostalAddress() != null){
            addressButton.setSelected(true);
            addressButtonActionPerformed(null);
            postalAddress.setText(product.getManufacturer().getPostalAddress().getStreet());
        }else {
        ...
        if (product.getManufacturer() != null && product.getManufacturer().getPostalAddress() != null &&
            ...
            xLoc.setText(product.getManufacturer().getPostalAddress().getTown().getX().toString());
        }
        if (product.getManufacturer() != null && product.getManufacturer().getPostalAddress() != null &&
                product.getManufacturer().getPostalAddress().getTown() != null){
            xLoc.setText(((Integer)product.getManufacturer().getPostalAddress().getTown().getY()).toString());
        }
        if (product.getManufacturer() != null && product.getManufacturer().getPostalAddress() != null &&
                product.getManufacturer().getPostalAddress().getTown() != null){
            xLoc.setText(product.getManufacturer().getPostalAddress().getTown().getZ().toString());
        }
